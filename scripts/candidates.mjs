...
const TERMS = {
  ...
  "dissolution": [["Julia Margaret Cameron photograph", "photograph"], ["Hiroshige rain woodblock print", "print"], ["fog photograph 1900s", "photograph"], ["steam locomotive fog painting"], ["marsh dawn painting"], ["HABS ruins", "building"], ["weathered wood bowl", "object"], ["twilight harbour painting"], ["nocturne sea painting"], ["fog painting"], ["mist landscape painting"],
                            ["rain seascape painting"], ["dusk river painting"],
                            ["raku tea bowl", "object"]],
  "invincible summer": [["Alphonse Mucha poster", "poster"], ["Art Nouveau poster summer", "poster"], ["Hokusai woodblock print", "print"], ["haystacks painting"], ["bathers river painting"], ["sunlit wall painting"], ["HABS barn interior", "building"], ["heat haze painting"], ["swimmers river painting"], ["summer heat painting"], ["sunlight field painting"],
                            ["midday sun painting"], ["harvest summer landscape painting"],
                            ["HABS porch veranda", "building"]],
  "nerve": [["World War II poster", "poster"], ["constructivist poster Rodchenko", "poster"], ["Soviet propaganda poster 1920s", "poster"], ["lifeboat rescue painting"], ["breaking waves rocks painting"], ["HAER dam spillway", "building"], ["climbing rope", "object"], ["volcano eruption painting"], ["rapids river painting"], ["storm sea painting"], ["climbing mountain painting"],
